...
const instructionRows = [
  ...
  ["Força exige Reps mín e Reps máx. Tempo exige Duração (HH:MM:SS)."],
  ["Distância e cardio exigem Duração (HH:MM:SS) ou Distância (m)."],
  ["Exemplo de tempo: 00:30:00 representa 30 minutos."],
